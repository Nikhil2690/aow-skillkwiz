...
export default function SiteHeader() {
  ...
  return (
    <div className="w-full fixed top-0 left-0 z-50">
      <nav className="flex flex-col w-full md:w-4/5 lg:w-3/5 xl:w-1/2 mx-auto bg-white text-black rounded-b-3xl">
        <div className="flex items-center px-4">
          {/* Logo */}
          <Link
            href="/"
            className={`md:hidden relative group py-4 px-2 text-sm lg:text-base transition-all ${
              pathname === "/" ? "text-yellow-400 font-semibold" : "text-black"
            }`}
          >
            <div className="relative flex justify-start items-center">
            <div className="w-32 h-20 flex items-center justify-start">
              <Image
                src="/images/replacedlogo.svg"
                alt="SkillKwiz Logo"
                width={140}
                height={80}
          ...
          <div className="hidden md:flex md:items-center md:flex-1">
            <Link
              href="/"
              className={`relative mr-10 group py-4 px-2 text-sm lg:text-base md:px-4 transition-all ${
                pathname === "/"
            ...
            >
              <div className="relative flex justify-start items-center">
                <div className="w-44 h-16 flex items-center justify-start overflow-hidden">
                  <Image
                    src="/images/replacedlogo.svg"
                    alt="SkillKwiz Logo"
                    width={100}
